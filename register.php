                ...
                mysqli_query(
                    ...
                    "UPDATE users
                     SET role='admin',
                         ...
                         company_seal_file='" . mysqli_real_escape_string($conn, basename((string)printing_default_user_value($conn, 'company_seal_file', printing_default_company_seal_filename()))) . "',
                         paid_seal_file='" . mysqli_real_escape_string($conn, basename((string)printing_default_user_value($conn, 'paid_seal_file', printing_default_paid_seal_filename()))) . "',
