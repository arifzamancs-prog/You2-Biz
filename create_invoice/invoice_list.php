...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form method="get" class="mb-3"><div class="row">
            ...
            <div class="col-md-3 form-group"><label>From Payment Date</label><input type="date" name="date_from" class="form-control" value="<?= htmlspecialchars($date_from); ?>"></div>
            <div class="col-md-3 form-group"><label>To Payment Date</label><input type="date" name="date_to" class="form-control" value="<?= htmlspecialchars($date_to); ?>"></div>
        ...
        <table id="example1" class="table table-bordered table-striped"><thead><tr><th>Invoice No</th><th>Type</th><th>Payment Date</th><th>Customer</th><th><?= htmlspecialchars($project_package_labels['project']); ?></th><th><?= htmlspecialchars($project_package_labels['package']); ?></th><th>Amount</th><th>Status</th><th width="190">Action</th></tr></thead><tbody>
