...
function system_settings_defaults()
{
    return [
        ...
        'site_logo_file' => '',
        'site_favicon_file' => '',
        'single_user_license_status' => 'inactive',
        'single_user_license_company_id' => '0',
        'single_user_license_logo_file' => '',
        'single_user_license_site_title' => '',
        'single_user_license_slogan' => '',
        ...
        'default_company_seal_file' => 'default-company-seal.png',
        'default_paid_seal_file' => 'default-paid-seal.png',
        'default_print_company_seal' => 'inactive',
        'default_print_paid_seal' => 'inactive',
        'default_print_company_logo' => 'active',
