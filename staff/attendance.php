...
<div class="table-responsive"><table class="table table-bordered table-striped"><thead><tr><th>Staff</th><th>Designation</th><th>Branch</th><th class="text-center">Present</th><th class="text-center">Late</th><th class="text-center">Absent</th><th class="text-center">Casual Leave</th><th class="text-center">Medical Leave</th><th class="text-center">Office Closed Day</th></tr></thead><tbody><?php while($yearly_summary=mysqli_fetch_assoc($yearly_attendance_summary)){ ?><tr><td><?=htmlspecialchars($yearly_summary['name'])?> <small class="text-muted">(<?=htmlspecialchars($yearly_summary['staff_code'])?>)</small></td><td><?=htmlspecialchars($yearly_summary['designation'] ?: '-')?></td><td><?= htmlspecialchars($yearly_summary['branch_name']) ?></td><td class="text-center"><span class="badge badge-success"><?=(int)$yearly_summary['present_count']?></span></td><td class="text-center"><span class="badge badge-warning"><?=(int)$yearly_summary['late_count']?></span></td><td class="text-center"><span class="badge badge-danger"><?=(int)$yearly_summary['absent_count']?></span></td><td class="text-center"><span class="badge badge-info"><?=(int)$yearly_summary['casual_leave_count']?></span></td><td class="text-center"><span class="badge badge-primary"><?=(int)$yearly_summary['medical_leave_count']?></span></td><td class="text-center"><span class="badge badge-secondary"><?=(int)$yearly_summary['closed_day_count']?></span></td></tr><?php } ?></tbody></table></div>
</div></div>
